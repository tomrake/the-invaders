...
The game was clearly modeled after tweekable system with a lot of global tweeks.
...
Graphic objects could be placed in CLOS classification system. This has the benifit of simplication of (mothership-x *mothership*) into (x motherhsip).
...
Several playfield bounds type issues for the shots, enemy players and mothershipare spread at various places in the code.
